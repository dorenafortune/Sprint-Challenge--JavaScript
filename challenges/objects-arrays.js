...
const dino1 = new Object();

dino1.name = "tyrannosaurus";
dino1.diet = "carnivorous";
dino1.weight = "7000kg";
dino1.length = "12m";
dino1.period = "Late Cretaceous";
  function roar (){
...
const dino3 = new Object();

dino3.name = "stegosaurus";
dino3.diet = "herbivorous";
dino3.weight = "2000kg";
dino3.length = "9m";
dino3.period = "Late Jurassic"
...
Log the result of your new array. */
  const contactInfo = [];
  graduates.forEach(function(studentelement){
    contactInfo.push(`${studentelement.first_name} ${studentelement.email}`);
  });
...
*/
const displayNames = [];
zooAnimals.forEach(function(zooelement){
  displayNames.push(`${zooelement.animal_name} ${zooelement.scientific_name}`);
});
